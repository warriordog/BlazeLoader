...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
        ...
        if (var8 != null) {
            ...
            if (var12 != null) {
                ...
                for (Entity aVar12 : var12) {
                    aVar12.setEntityId(aVar12.getEntityId() + var10);
                }
            }
    ...
    public void handleSpawnMob(S0FPacketSpawnMob p_147281_1_) {
        ...
        if (var11 != null) {
            ...
            for (Entity aVar11 : var11) {
                aVar11.setEntityId(aVar11.getEntityId() + var12);
            }
        }
    ...
    public void handleOpenWindow(S2DPacketOpenWindow p_147265_1_) {
        ...
        switch (p_147265_1_.func_148899_d()) {
            ...
            default:
                EventHandler.overrideOnContainerOpen(var2, p_147265_1_);
        }
    }
    ...
    public void handleEntityProperties(S20PacketEntityProperties p_147290_1_) {
        ...
        if (var2 != null) {
            if (!(var2 instanceof EntityLivingBase)) {
                ...
                for (Object o1 : p_147290_1_.func_149441_d()) {
                    S20PacketEntityProperties.Snapshot var5 = (S20PacketEntityProperties.Snapshot) o1;
                    ...
                    for (Object o : var5.func_151408_c()) {
                        AttributeModifier var8 = (AttributeModifier) o;
