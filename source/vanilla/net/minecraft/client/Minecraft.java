...
public class Minecraft implements IPlayerUsage {
    ...
    public void displayGuiScreen(GuiScreen p_147108_1_) {
        ...
        if (p_147108_1_ == null && this.thePlayer != null && this.thePlayer.getHealth() <= 0.0F) {
        ...
        if (p_147108_1_ != null) {
            GuiScreen gui = ModList.onGui(p_147108_1_);
            if (gui != null) {
                doHandle = true;
            }
        } else {
        ...
        if (doHandle) {
            ...
            } else if (this.thePlayer != null && p_147108_1_ == null && this.thePlayer.getHealth() <= 0.0F) {
