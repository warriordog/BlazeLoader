...
public class BLEventInjectionTransformerClient extends BLEventInjectionTransformer {
    ...
    protected void addBLEvents() {
        ...
        addBLEvent(EventSide.CLIENT, "net.minecraft.client.multiplayer.worldClient.func_180503_b (Lnet/minecraft/util/BlockPos;Lnet/minecraft/block/state/IBlockState;)V");
