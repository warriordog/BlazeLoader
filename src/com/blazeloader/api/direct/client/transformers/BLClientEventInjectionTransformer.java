...
public class BLClientEventInjectionTransformer extends BLBaseEventInjectionTransformer {
    ...
    protected void addEvents() {
        try {
            ...
            addBLEvent(SIDE_SERVER, "net.minecraft.server.management.ServerConfigurationManager.respawnPlayer (Lnet/minecraft/entity/player/EntityPlayerMP;IZ)Lnet/minecraft/entity/player/EntityPlayerMP;");
        } catch (Exception e) {
