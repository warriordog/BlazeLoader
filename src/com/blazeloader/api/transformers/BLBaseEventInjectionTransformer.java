...
public abstract class BLBaseEventInjectionTransformer extends EventInjectionTransformer {
    ...
    protected static final String EVENT_HANDLER_BASE = "com.blazeloader.api.event.EventHandlerBase";
    protected static final String EVENT_HANDLER_CLIENT = "com.blazeloader.api.client.event.EventHandlerClient";
    protected static final String EVENT_HANDLER_SERVER = "com.blazeloader.api.event.EventHandlerServer";
