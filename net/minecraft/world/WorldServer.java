...
public class WorldServer extends World {
    ...
    private ServerBlockEventListNew[] field_147490_S = new ServerBlockEventListNew[]{new ServerBlockEventListNew(null), new ServerBlockEventListNew(null)};
    ...
    protected void onEntityAdded(Entity par1Entity) {
        ...
        if (var2 != null) {
            for (Entity aVar2 : var2) {
                this.entityIdMap.addKey(aVar2.getEntityId(), aVar2);
            }
        }
    }
    ...
    protected void onEntityRemoved(Entity par1Entity) {
        ...
        if (var2 != null) {
            for (Entity aVar2 : var2) {
                this.entityIdMap.removeObject(aVar2.getEntityId());
            }
        }
    }
